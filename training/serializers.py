...
class ScheduleSerializer(serializers.ModelSerializer):
    class Meta:
        model = Schedule
        fields = ["id", "func", "kwargs",
                  "schedule_type", "next_run", "repeats"]
...
class TrainingDocumentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'name', 'original_file', 'created_at',
                  'created_by_username', 'processed']
...
class TrainingRunSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = TrainingRun
        fields = ['id', 'model_name', 'source', 'created_at',
